...
namespace OpenApparatus.Unity
{
    ...
    /// <see cref="ApparatusAsset"/> and layers build options plus per-room and
    ...
    /// </summary>
    [CreateAssetMenu(fileName = "ApparatusConfig", menuName = "OpenApparatus/Apparatus Config")]
    public sealed class ApparatusConfig : ScriptableObject
    {
        [Tooltip("Imported .oae / .oapp asset this configuration builds from.")]
        public ApparatusAsset Source;
        ...
        [Tooltip("Room id to centre the apparatus on; -1 leaves the source origin.")]
        ...
        public ObjectTypeConfig[] ObjectTypes;
    ...
    [Serializable]
    public sealed class ObjectTypeConfig
    {
