...
{
    public sealed class OApparatusRoomManagerTests
    {
        ...
        public void Room_CarriesItsWalls_AfterSpawn()
        {
            ...
            {
                root = OApparatusSpawner.Spawn(asset);
                var room = root.GetComponent<OApparatusRootManager>().GetRoom(0);
        ...
        public void Spawn_SetsObjectTypeOnInstance()
        {
            ...
            {
                root = OApparatusSpawner.Spawn(asset);
                var obj = root.GetComponentInChildren<OApparatusObjectManager>();
