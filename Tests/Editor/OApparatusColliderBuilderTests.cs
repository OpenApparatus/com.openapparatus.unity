...
{
    public sealed class OApparatusColliderBuilderTests
    {
        ...
        [TestCase(OApparatusColliderMode.None,                        0, 0, 0)]
        [TestCase(OApparatusColliderMode.Walls,                       1, 0, 0)]
        [TestCase(OApparatusColliderMode.Floors,                      0, 1, 0)]
        [TestCase(OApparatusColliderMode.Ceilings,                    0, 0, 1)]
        [TestCase(OApparatusColliderMode.Walls | OApparatusColliderMode.Floors, 1, 1, 0)]
        [TestCase(OApparatusColliderMode.All,                         1, 1, 1)]
        ...
        public void Placeholder_KeepsColliderWhenObjectsFlagSet()
        {
            ...
            {
                root = OApparatusSpawner.Spawn(asset);
                var placeholder = root.GetComponentInChildren<OApparatusObjectManager>();
        ...
        public void SubstitutedPrefab_ColliderIsPrefabAuthorsChoice()
        {
            ...
            table.Entries = new[]
            {
                new OApparatusSubstitutionEntry { ObjectType = "Cup", Prefab = bare,
            ...
            {
                root = OApparatusSpawner.Spawn(asset);
                var instance = root.GetComponentInChildren<OApparatusObjectManager>();
