...
{
    [CustomEditor(typeof(OApparatusOaeImporter))]
    public sealed class OApparatusOaeImporterEditor : ScriptedImporterEditor
    {
        ...
        {
            var importer = (OApparatusOaeImporter)target;
        ...
        static void DrawSummary(OApparatusAsset asset)
        {
            ...
            if (asset.ObjectSlots != null && asset.ObjectSlots.Length > 0)
            {
                ...
                EditorGUILayout.HelpBox(
                    ...
                    "value in a OApparatusSubstitutionTable entry.",
                    MessageType.None);
