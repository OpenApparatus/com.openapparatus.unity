...
{
    [CustomEditor(typeof(OApparatusSubstitutionTable))]
    public sealed class OApparatusSubstitutionTableEditor : UnityEditor.Editor
    {
        ...
        void OnEnable()
        {
            _entriesProp = serializedObject.FindProperty(nameof(OApparatusSubstitutionTable.Entries));
